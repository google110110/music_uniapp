...
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;function ownKeys(object, enumerableOnly) {var keys = Object.keys(object);if (Object.getOwnPropertySymbols) {var symbols = Object.getOwnPropertySymbols(object);if (enumerableOnly) symbols = symbols.filter(function (sym) {return Object.getOwnPropertyDescriptor(object, sym).enumerable;});keys.push.apply(keys, symbols);}return keys;}function _objectSpread(target) {for (var i = 1; i < arguments.length; i++) {var source = arguments[i] != null ? arguments[i] : {};if (i % 2) {ownKeys(Object(source), true).forEach(function (key) {_defineProperty(target, key, source[key]);});} else if (Object.getOwnPropertyDescriptors) {Object.defineProperties(target, Object.getOwnPropertyDescriptors(source));} else {ownKeys(Object(source)).forEach(function (key) {Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key));});}}return target;}function _defineProperty(obj, key, value) {if (key in obj) {Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true });} else {obj[key] = value;}return obj;}var _default = function _default(params) {
  ...
  var url = "https://autumnfish.cn".concat(params.url);
  var query = _objectSpread({}, params, { url: url });
...
var songid = 0;
var nowmiao = 0;
var playSong = { flag: true };

var audioList = uni.getStorageSync('playlist').tracks;

var _this = _vue.default.prototype;

var getSongId = function getSongId(id) {
  uni.setStorageSync('songid', id);
};
var setAudioPlaySrc = function setAudioPlaySrc(index) {
  audioPlaySrc = index;
};
var setSongId = function setSongId(id) {
  songid = id;
};
var getSongUrl = function getSongUrl(songid) {
...
var audioInit = function audioInit(songsrc) {
  var src = songsrc;
  _this.$minRadio.pause();
  if (_this.$innerAudioContext.src) {
    _this.$innerAudioContext.pause();
  }
  var innerAudioContext = _this.$innerAudioContext;
  _this.$innerAudioContext.src = src;
  _this.$innerAudioContext.autoplay = true;
  //监听事件
  _this.$innerAudioContext.onError(function () {
    nextPlay();
    uni.showModal({
      title: '收费歌曲',
  ...
  _this.$innerAudioContext.onTimeUpdate(function (e) {
...
var audioWayFunc = function audioWayFunc(index) {
  if (index) {
    audioWay = index;
    return audioWay;
  }
...
};var _default =
{
  ...
  playFunc: playFunc,
  songid: songid,
  audioWayFunc: audioWayFunc,
  setAudioPlaySrc: setAudioPlaySrc,
  setSongId: setSongId,
  getSongId: getSongId,
  playSong: playSong };exports.default = _default;
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./node_modules/@dcloudio/uni-mp-weixin/dist/index.js */ 1)["default"]))
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _default = { "pages": { "pages/index/index": { "navigationBarTitleText": "music", "usingComponents": { "uni-header": "/components/header/index", "uni-icons": "/components/uni-icons/uni-icons", "songslist": "/components/songslist/index", "song": "/components/song/index", "mv": "/components/mv/index", "uni-drawer": "/components/uni-drawer/uni-drawer" }, "usingAutoImportComponents": { "uni-icons": "/components/uni-icons/uni-icons", "uni-fab": "/components/uni-fab/uni-fab", "uni-drawer": "/components/uni-drawer/uni-drawer" } }, "pages/me/me": { "navigationBarTitleText": "我的", "usingComponents": { "w-input": "/components/watch-login/watch-input", "w-button": "/components/watch-login/watch-button" }, "usingAutoImportComponents": {} }, "pages/village/village": { "navigationBarTitleText": "云村", "usingComponents": { "wfalls-flow": "/components/wfalls-flow/wfalls-flow" }, "usingAutoImportComponents": { "wfalls-flow": "/components/wfalls-flow/wfalls-flow" } }, "pages/mv/mv": { "navigationBarTitleText": "MV", "usingComponents": { "mv": "/components/mv/index", "my-videos": "/components/myvideo/index" }, "usingAutoImportComponents": { "uni-icons": "/components/uni-icons/uni-icons" } }, "pages/playlist/playlist": { "navigationBarTitleText": "", "usingComponents": {}, "usingAutoImportComponents": {} }, "pages/music/music": { "navigationBarTitleText": "音乐", "usingComponents": {}, "usingAutoImportComponents": {} }, "pages/songlist/songlist": { "navigationBarTitleText": "歌单列表", "usingComponents": { "ms-tabs": "/components/ms-tabs/ms-tabs", "uni-grid": "/components/uni-grid/uni-grid", "uni-grid-item": "/components/uni-grid-item/uni-grid-item", "list": "/components/list/index" }, "usingAutoImportComponents": { "ms-tabs": "/components/ms-tabs/ms-tabs" } }, "pages/top/top": { "navigationBarTitleText": "排行榜", "usingComponents": { "lists": "/components/list/index" }, "usingAutoImportComponents": {} }, "pages/radiostation/radiostation": { "navigationBarTitleText": "电台", "usingComponents": { "list": "/components/list/index" }, "usingAutoImportComponents": {} }, "pages/djtype/djtype": { "navigationBarTitleText": "电台类型", "usingComponents": { "list": "/components/list/index" }, "usingAutoImportComponents": {} }, "pages/djdetails/djdetails": { "navigationBarTitleText": "电台详情", "usingComponents": {}, "usingAutoImportComponents": {} }, "pages/fm/fm": { "navigationBarTitleText": "私人FM", "enablePullDownRefresh": true, "usingComponents": {}, "usingAutoImportComponents": {} }, "pages/daily/daily": { "navigationBarTitleText": "每日推荐", "usingComponents": {}, "usingAutoImportComponents": {} }, "pages/moresonglist/moresonglist": { "navigationBarTitleText": "推荐歌单", "usingComponents": { "songslist": "/components/songslist/index" }, "usingAutoImportComponents": {} }, "pages/newsong/newsong": { "navigationBarTitleText": "推荐新歌", "usingComponents": { "song": "/components/song/index" }, "usingAutoImportComponents": {} }, "pages/mvdetails/mvdetails": { "navigationBarTitleText": "MV详情", "usingComponents": { "my-ideos": "/components/myvideo/index" }, "usingAutoImportComponents": { "uni-icons": "/components/uni-icons/uni-icons" } }, "pages/mvtype/mvtype": { "navigationBarTitleText": "MV分类", "usingComponents": {}, "usingAutoImportComponents": {} }, "pages/mvtop/mvtop": { "navigationBarTitleText": "MV排行榜", "usingComponents": {}, "usingAutoImportComponents": {} }, "pages/search/search": { "navigationBarTitleText": "热门搜索", "usingComponents": { "uni-search-bar": "/components/uni-search-bar/uni-search-bar" }, "usingAutoImportComponents": { "uni-search-bar": "/components/uni-search-bar/uni-search-bar" } } }, "globalStyle": { "navigationBarTextStyle": "black", "navigationBarTitleText": "uni-app", "navigationBarBackgroundColor": "#F8F8F8", "backgroundColor": "#F8F8F8", "onReachBottomDistance": 20 } };exports.default = _default;
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _default = { "appid": "__UNI__CD6D908" };exports.default = _default;
